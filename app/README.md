# PinteMod Control Center — candidat recette v2.4.5-rc25

La version stable publique reste `2.4.4`. Le candidat `2.4.5-rc25` prépare la recette terrain finale : fermeture locale bornée, assistant RCON optionnel uniquement pour un serveur vierge, remplacement confirmé d’un RCON existant sans l’afficher, ouverture automatique du tableau de bord après lancement, Agent LAN activable explicitement, interface compatible session distante et dossier autonome. Un silence RCON reste distinct de l’état local PinteMod.
...
```text
app\artifacts\release-v2.4.5-rc25-win-x64\single-exe\PinteMod.ControlCenter.exe
app\artifacts\release-v2.4.5-rc25-win-x64\folder\
app\artifacts\release-v2.4.5-rc25-win-x64\PinteMod.ControlCenter-single-exe-win-x64.zip
app\artifacts\release-v2.4.5-rc25-win-x64\PinteMod.ControlCenter-folder-win-x64.zip
app\artifacts\release-v2.4.5-rc25-win-x64\SHA256SUMS.txt
app\artifacts\release-v2.4.5-rc25-win-x64\SELF-TEST.txt
```
