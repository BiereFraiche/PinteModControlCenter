...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc26-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc26
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc26 : résultat RCON affiché immédiatement, fermeture bornée et Agent distant explicite.
