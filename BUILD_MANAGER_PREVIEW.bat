...
set "OUTROOT=%APP%\artifacts\release-v2.4.1-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - RELEASE STABLE v2.4.1
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Stable v2.4.1 : port BOIII/RCON détecté depuis Server.bat quand il est déclaré.
