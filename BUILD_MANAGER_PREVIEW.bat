...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc9-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc9
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc9 : démarrage WPF résilient, diagnostic sûr, récupération des profils et RCON PinteMod natif.
