...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc28-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc28
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc28 : désactivation complète de l’Agent, réparation RCON et fermeture bornée.
