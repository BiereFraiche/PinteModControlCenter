...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc24-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc24
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc24 : remplacement RCON confirmé et masqué, Agent distant explicite et paramètres sans espaces inutiles.
