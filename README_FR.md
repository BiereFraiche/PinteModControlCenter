...
> **Version stable actuelle : v2.4.4.** Le sélecteur 🇫🇷/🇬🇧 est mémorisé dans la barre de titre ; **Démarrer** comme **Lancer tous** peuvent lancer un premier serveur PinteMod local sans RCON préalable. La [candidate v2.4.5-rc6](https://github.com/BiereFraiche/PinteModControlCenter/releases/tag/v2.4.5-rc6) attend uniquement la recette terrain finale.
...
![Tests](https://img.shields.io/badge/tests-621%20r%C3%A9ussis-24C875)
...
> La candidate **v2.4.5-rc6** termine Debug et Release avec **0 avertissement, 0 erreur et 621/621 tests réussis**. Elle reste une prépublication jusqu’à la recette BOIII réelle.
> Sans configuration explicite, l’application démarre toujours en simulation complète.

[Télécharger la stable v2.4.4](https://github.com/BiereFraiche/PinteModControlCenter/releases/tag/v2.4.4) · [Tester la candidate v2.4.5-rc6](https://github.com/BiereFraiche/PinteModControlCenter/releases/tag/v2.4.5-rc6)
