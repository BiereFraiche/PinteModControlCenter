...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc8-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc8
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc8 : diagnostic de démarrage sûr, récupération des profils, RCON PinteMod natif et langue mémorisée.
