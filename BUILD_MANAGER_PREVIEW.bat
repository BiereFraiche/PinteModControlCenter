...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc3-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc3
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc3 : premier lancement simplifié, RCON PinteMod natif et langue mémorisée.
