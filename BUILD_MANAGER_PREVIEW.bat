...
set "OUTROOT=%APP%\artifacts\release-v2.4.0-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - RELEASE STABLE v2.4.0
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Stable v2.4.0 : hotfix.gsc Ezz BOIII reconnu comme absence attendue.
