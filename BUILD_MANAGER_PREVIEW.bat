...
set "OUTROOT=%APP%\artifacts\release-v2.4.5-rc27-win-x64"
...
echo ============================================================
echo  PinteMod Control Center - CANDIDAT RECETTE v2.4.5-rc27
echo ============================================================
echo.
...
echo   %OUT_SELFTEST%
echo.
echo Candidate v2.4.5-rc27 : réparation des secrets PinteMod manquants, résultat RCON immédiat et fermeture bornée.
